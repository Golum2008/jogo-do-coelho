...
function draw() {
  ...
  //exibir a corda -- aluno
rope.show();
  //exibir a fruta -- aluno
ellipse(fruite.position.x,fruite.position.y,30,30);
  //exibir ground
  ground.show();
}
